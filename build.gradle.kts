...
application {
    mainClass.set("com.runt9.namelessAnomalies.NALauncher")
}
...
runtime {
    ...
    jpackage {
        ...
        imageName = "Nameless Anomalies"
        installerName = "Nameless Anomalies"
        ...
        if (currentOs.isWindows) {
            ...
            installerOptions.addAll(listOf("--linux-package-name", "nameless-anomalies", "--linux-shortcut"))
        } else if (currentOs.isMacOsX) {
            installerOptions.addAll(
                listOf(
                    "--mac-package-name", "Nameless Anomalies",
                    "--mac-package-identifier", "nameless-anomalies"
                )
            )
